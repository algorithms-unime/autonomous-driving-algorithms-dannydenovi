...
DEPENDENCIES := tensorflow==1.14.0 tensorboard==1.15.0 gym==0.22 pillow==9.5.0 stable-baselines3==1.8.0 torch==1.11.0 pyglet==1.5.27 h5py==2.8.0 opencv-python==3.4.2.17 protobuf==3.20.0 git+https://github.com/tawnkramer/gym-donkeycar

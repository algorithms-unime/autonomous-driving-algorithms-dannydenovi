...
DEPENDENCIES := gym==0.21 git+https://github.com/tawnkramer/gym-donkeycar tensorboard==2.12.2 pillow==9.5.0 stable-baselines3==1.6.2 pyglet==1.5.27 numpy==1.22.3 torch==1.11.0 

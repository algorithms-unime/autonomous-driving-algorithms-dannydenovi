...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_name", type=str, default="donkey-minimonaco-track-v0", help="name of donkey sim environment", choices=env_list)
    ...
    parser.add_argument("--model", type=str, default="ppo_donkey", help="Specify path for model")
    ...
    if args.test:
        ...
        if args.retrain:
            ...
            model = PPO.load(args.model, env=env,  tensorboard_log="./ppo_donkeycar_tensorboard/")
        else:
